...
- [current time zone](#current-time-zone)
  - [CurrentTimeZone (class)](#currenttimezone-class)
...
- [models](#models)
  - [DateTime (type alias)](#datetime-type-alias)
  - [Disambiguation (type alias)](#disambiguation-type-alias)
  - [TimeZone (type alias)](#timezone-type-alias)
  - [Utc (interface)](#utc-interface)
  - [Zoned (interface)](#zoned-interface)
- [ordering](#ordering)
  - [clamp](#clamp)
- [parts](#parts)
  - [getPart](#getpart)
...
- [utils](#utils)
  - [DateTime (namespace)](#datetime-namespace)
    - [PartsWithWeekday (interface)](#partswithweekday-interface)
    - [Parts (interface)](#parts-interface)
    - [PartsForMath (interface)](#partsformath-interface)
    - [Instant (interface)](#instant-interface)
    - [InstantWithZone (interface)](#instantwithzone-interface)
    - [Proto (interface)](#proto-interface)
    - [Input (type alias)](#input-type-alias)
    - [PreserveZone (type alias)](#preservezone-type-alias)
    - [Unit (type alias)](#unit-type-alias)
    - [UnitSingular (type alias)](#unitsingular-type-alias)
    - [UnitPlural (type alias)](#unitplural-type-alias)
  - [TimeZone (namespace)](#timezone-namespace)
    - [Proto (interface)](#proto-interface-1)
...
If `other` is _after_ `self`, the result will be a positive `Duration`. If
`other` is _before_ `self`, the result will be a negative `Duration`. If they
...
[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/DateTime.ts#L83)
...
[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/DateTime.ts#L285)
