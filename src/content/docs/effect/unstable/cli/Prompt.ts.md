...
- [models](#models)
  ...
  - [ActionDefinition (interface)](#actiondefinition-interface)
  - [Environment (type alias)](#environment-type-alias)
  - [Handlers (interface)](#handlers-interface)
  - [ProcessInput (type alias)](#processinput-type-alias)
  - [Prompt (interface)](#prompt-interface)
  - [SelectChoice (interface)](#selectchoice-interface)
- [options](#options)
  - [AutoCompleteOptions (interface)](#autocompleteoptions-interface)
  - [ConfirmOptions (interface)](#confirmoptions-interface)
  - [DateOptions (interface)](#dateoptions-interface)
  - [FileOptions (interface)](#fileoptions-interface)
  ...
  - [MultiSelectOptions (interface)](#multiselectoptions-interface)
  - [SelectOptions (interface)](#selectoptions-interface)
  - [TextOptions (interface)](#textoptions-interface)
  - [ToggleOptions (interface)](#toggleoptions-interface)
...
[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/Prompt.ts#L938)
...
[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/Prompt.ts#L1060)
...
```ts
type ReturnIterable<T> = [T] extends [Iterable<Prompt<infer A>>] ? Prompt<Array<A>> : never
```
...
```ts
type ReturnObject<T> = [T] extends [{ [K: string]: Any }]
  ? Prompt<{
      -readonly [K in keyof T]: [T[K]] extends [Prompt<infer _A>] ? _A : never
    }>
  : never
...
```ts
type Return<Arg> = [Arg] extends [ReadonlyArray<Any>]
  ? ReturnTuple<Arg>
