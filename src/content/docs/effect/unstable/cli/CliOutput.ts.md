...
}).pipe(Effect.provide(NoColorLayer))
...
```ts
declare const Formatter: Context.Reference<Formatter>
```

[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/CliOutput.ts#L228)
