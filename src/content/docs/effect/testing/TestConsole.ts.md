...
- [layers](#layers)
  - [layer](#layer)
- [models](#models)
  - [TestConsole (interface)](#testconsole-interface)
- [testing](#testing)
  - [errorLines](#errorlines)
  - [logLines](#loglines)
  - [testConsoleWith](#testconsolewith)
- [utils](#utils)
  - [TestConsole (namespace)](#testconsole-namespace)
...
[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/TestConsole.ts#L90)
