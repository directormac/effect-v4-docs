...
- `NonEmptyIterable` for the branded iterable type that uses this symbol
...
function reduceNonEmpty<A, B>(data: NonEmptyIterable.NonEmptyIterable<A>, f: (acc: B, current: A) => B, initial: B): B {
