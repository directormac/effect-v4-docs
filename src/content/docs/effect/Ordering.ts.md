...
const compareNumbers = (a: number, b: number): Ordering.Ordering => (a < b ? -1 : a > b ? 1 : 0)

const compareDescending = (a: number, b: number): Ordering.Ordering => Ordering.reverse(compareNumbers(a, b))
