...
- [models](#models)
  ...
  - [TxDequeue (interface)](#txdequeue-interface)
  - [TxEnqueue (interface)](#txenqueue-interface)
  - [TxQueue (interface)](#txqueue-interface)
  - [TxQueueState (interface)](#txqueuestate-interface)
- [taking](#taking)
  - [takeBetween](#takebetween)
- [utils](#utils)
  - [TxDequeue (namespace)](#txdequeue-namespace)
    - [Variance (interface)](#variance-interface)
  - [TxEnqueue (namespace)](#txenqueue-namespace)
    - [Variance (interface)](#variance-interface-1)
  - [TxQueue (namespace)](#txqueue-namespace)
    - [Variance (interface)](#variance-interface-2)
...
const program = Effect.gen(function* () {
  ...
  const completableQueue = yield* TxQueue.bounded<string, Cause.Done>(5)
...
[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/TxQueue.ts#L79)
...
[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/TxQueue.ts#L115)
