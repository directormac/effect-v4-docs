...
- [mapping](#mapping)
  - [map](#map)
- [models](#models)
  - [TxHashSet (interface)](#txhashset-interface)
- [mutations](#mutations)
  - [add](#add)
  - [clear](#clear)
  - [remove](#remove)
- [utils](#utils)
  - [TxHashSet (namespace)](#txhashset-namespace)
...
[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/TxHashSet.ts#L119)
