---
title: ExecutionPlan.ts
nav_order: 30
parent: "effect"
---

## ExecutionPlan.ts overview
...
- [models](#models)
  - [ConfigBase (type alias)](#configbase-type-alias)
  - [ExecutionPlan (interface)](#executionplan-interface)
- [type IDs](#type-ids)
  - [TypeId](#typeid)
...
- [utils](#utils)
  - [make (namespace)](#make-namespace)
    ...
    - [StepProvides (type alias)](#stepprovides-type-alias)
    - [PlanProvides (type alias)](#planprovides-type-alias)
    - [StepInput (type alias)](#stepinput-type-alias)
    - [PlanInput (type alias)](#planinput-type-alias)
...
[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/ExecutionPlan.ts#L39)
...
[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/ExecutionPlan.ts#L246)
