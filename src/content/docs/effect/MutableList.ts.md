...
- [utils](#utils)
  - [MutableList (namespace)](#mutablelist-namespace)
...
function drainAndProcess<T>(list: MutableList.MutableList<T>, processor: (items: Array<T>) => void) {
  if (list.length > 0) {
...
[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/MutableList.ts#L176)
